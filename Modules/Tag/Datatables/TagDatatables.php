<?php
namespace Modules\Tag\DataTables;
...
class TagDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'tags.edit';
    ...
    public function dataTable($query)
    {
        ...
        $dataTable->addColumn('actions', function ($data) {
            return view('core::crud.module.actions', ['route' => 'tags', 'id' => $data->id]);
        });
